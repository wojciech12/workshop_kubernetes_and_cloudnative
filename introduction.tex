...
We need to move \verb|intro-app| to kubernetes. Users will acess this application: \verb|my.app/echo|. Please help us, our next finanse round depens on it.
...
\smallskip
Notice: the postfix \verb|-deploy| is not the best practise, just to make it more explicit during the training.
