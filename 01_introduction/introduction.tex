...
Applications (see in the \verb|examples| directory):
...
2. ConfigMap with a field DB_NAME and DB_PORT
3. Secret
3. Service
4. Ingress, path: `/hello` to `/`
\end{markdown}

%
\section{Quick look on the configuration management}
